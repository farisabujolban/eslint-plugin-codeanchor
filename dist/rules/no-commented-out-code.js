...
function codeLineRatio(commentText) {
...
export const noCommentedOutCode = {
    meta: {
        ...
        messages: {
            commentedOutCode: 'This comment block appears to contain commented-out code. Remove or restore it.',
        },
    },
    create(context) {
                ...
                while (i < comments.length) {
                    ...
                    if (c.type === 'Line') {
                        ...
                        while (j < comments.length) {
                            ...
                            if (next.loc.start.line > prevLine + 1)
                                break;
                            combinedText += '\n' + next.value;
                            j++;
                        }
