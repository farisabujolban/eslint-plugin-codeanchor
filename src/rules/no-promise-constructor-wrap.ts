...
export const noPromiseConstructorWrap: CodeAnchorRule = {
    meta: {
        ...
        docs: {
            description:
                'Disallow wrapping a Promise-returning function call in new Promise() — the outer wrapper is redundant and may swallow rejections.',
            recommended: true,
        ...
        messages: {
            unnecessaryWrapper:
                'new Promise(resolve => resolve(fn())) is redundant — fn() already returns a Promise. Return fn() directly.',
        },
    },
