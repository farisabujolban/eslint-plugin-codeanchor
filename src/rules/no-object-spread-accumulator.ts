...
export const noObjectSpreadAccumulator: CodeAnchorRule = {
  meta: {
    ...
    schema: [],
    messages: {
      spreadAccumulator: 'Spreading the accumulator inside .reduce() is O(n²). Use Object.fromEntries(), Object.assign(acc, {...}), or a mutable accumulator with a for-loop.',
    },
  },
